...
namespace ProcessJS.Plugins.Actions
{
    ...
    public class Disassociate : IPlugin
    {
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            service.Disassociate(target.LogicalName, target.Id, new Relationship(relationship), collection);
        }
    }
}
